...
<p align="justify">
 ...
 <ul>
  ...
  <li><b>Transferring datasets to Google Drive</b>: At the end of the notebook, there's a little cell that zips everything up and ships your datasets to your <code>datasets</code> folder. Run it, and you're keep calm.</li>
 </ul>
</p>
